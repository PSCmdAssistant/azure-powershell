...
-->
## Upcoming Release
* Added new parameters `EnableResilientVMCreate` and `EnableResilientVMDelete` to cmdlets `Update-AzVmss` and `New-AzVmssConfig` to enable Resilient VM Create and/or Resilient VM Delete on scale sets during a VMSS update or VMSS create operation.
