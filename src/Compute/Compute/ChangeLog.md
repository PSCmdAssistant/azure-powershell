...
-->
## Upcoming Release
* Added a new optional parameter `-SourceImageId` to the `New-AzGalleryImageVersion` cmdlet, allowing users to specify the source image ID for creating gallery image versions.
