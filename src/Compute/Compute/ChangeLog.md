...
-->
## Upcoming Release
* Added `--EnableUserRedeployScheduledEvents` boolean parameter to `Update-AzVmss`, `Set-AzVmss`, `Update-AzAvailabilitySet`, `Set-AzAvailabilitySet`, `Update-AzVM`, and `Set-AzVM` cmdlets to allow users to enable user redeploy scheduled events.
