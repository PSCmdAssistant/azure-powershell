...
-->
## Upcoming Release
* Added `AvailabilityPolicy` parameter to `Set-AzVMDataDisk` and `New-AzDiskUpdateConfig` cmdlets, allowing users to specify the availability policy with options for 'AutomaticReattach' or 'None'.
