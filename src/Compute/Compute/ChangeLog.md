...
-->
## Upcoming Release
* Implemented a feature in the New-AzVmss cmdlet to automatically set the image to Windows2022AzureEdition when the SecurityType parameter is explicitly set to Standard and the image value is not set by the user.
