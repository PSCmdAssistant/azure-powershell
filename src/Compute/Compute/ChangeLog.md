...
-->
## Upcoming Release
* Added new parameters `EnableResilientVMCreate` and `EnableResilientVMDelete` to `Update-AzVmss`, `New-AzVmssConfig`, and `Update-AzVm` cmdlets to enable Resilient VM Create and/or Resilient VM Delete on their scale sets during a VMSS update or VMSS create operation.
