...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    public partial class NewAzureRmVmssConfigCommand : Microsoft.Azure.Commands.ResourceManager.Common.AzureRMCmdlet
    {
        ...
        private void Run()
        {
            ...
            AutomaticZoneRebalancingPolicy vAutomaticZoneRebalancingPolicy = null;

            if (this.IsParameterBound(c => c.EnableAutomaticZoneRebalancingPolicy) || this.IsParameterBound(c => c.AutomaticZoneRebalanceStrategy) || this.IsParameterBound(c => c.AutomaticZoneRebalanceBehavior) || this.IsParameterBound(c => c.AutomaticZoneRebalanceTargetInstanceCount))
            {
                vAutomaticZoneRebalancingPolicy = new AutomaticZoneRebalancingPolicy
                {
                    EnableAutomaticZoneRebalancing = this.EnableAutomaticZoneRebalancingPolicy,
            ...
            var vVirtualMachineScaleSet = new PSVirtualMachineScaleSet
            {
                ...
                AutomaticZoneRebalancingPolicy = vAutomaticZoneRebalancingPolicy
            };
