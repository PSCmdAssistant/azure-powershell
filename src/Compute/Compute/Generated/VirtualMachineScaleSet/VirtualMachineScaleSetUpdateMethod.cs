...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    public partial class UpdateAzureRmVmss : ComputeAutomationBaseCmdlet
    {
        ...
        [Parameter(
            Mandatory = false,
            HelpMessage = "Specifies whether automatic zone rebalancing policy is enabled.")]
        ...
        [ValidateSet("Recreate", "TargetScaleOut", IgnoreCase = true)]
        ...
        [ValidateSet("CreateBeforeDelete", IgnoreCase = true)]
 ...
 private void BuildPatchObject()
        {
            ...
            if (this.IsParameterBound(c => c.EnableAutomaticZoneRebalancingPolicy))
            {
                ...
                this.VirtualMachineScaleSetUpdate.ZoneRebalancingPolicy.Enabled = this.EnableAutomaticZoneRebalancingPolicy;
            }
            ...
            if (this.IsParameterBound(c => c.AutomaticZoneRebalanceStrategy))
            {
                ...
                this.VirtualMachineScaleSetUpdate.ZoneRebalancingPolicy.Strategy = this.AutomaticZoneRebalanceStrategy;
            }
            ...
            if (this.IsParameterBound(c => c.AutomaticZoneRebalanceBehavior))
            {
                ...
                this.VirtualMachineScaleSetUpdate.ZoneRebalancingPolicy.Behavior = this.AutomaticZoneRebalanceBehavior;
            }
            ...
            if (this.IsParameterBound(c => c.AutomaticZoneRebalanceTargetInstanceCount))
            {
                ...
                this.VirtualMachineScaleSetUpdate.ZoneRebalancingPolicy.TargetInstanceCount = this.AutomaticZoneRebalanceTargetInstanceCount;
            }
 ...
 private void BuildPutObject()
        {
            ...
            if (this.IsParameterBound(c => c.EnableAutomaticZoneRebalancingPolicy))
            {
                ...
                this.VirtualMachineScaleSet.ZoneRebalancingPolicy.Enabled = this.EnableAutomaticZoneRebalancingPolicy;
            }
            ...
            if (this.IsParameterBound(c => c.AutomaticZoneRebalanceStrategy))
            {
                ...
                this.VirtualMachineScaleSet.ZoneRebalancingPolicy.Strategy = this.AutomaticZoneRebalanceStrategy;
            }
            ...
            if (this.IsParameterBound(c => c.AutomaticZoneRebalanceBehavior))
            {
                ...
                this.VirtualMachineScaleSet.ZoneRebalancingPolicy.Behavior = this.AutomaticZoneRebalanceBehavior;
            }
            ...
            if (this.IsParameterBound(c => c.AutomaticZoneRebalanceTargetInstanceCount))
            {
                ...
                this.VirtualMachineScaleSet.ZoneRebalancingPolicy.TargetInstanceCount = this.AutomaticZoneRebalanceTargetInstanceCount;
            }
        }
    }
}