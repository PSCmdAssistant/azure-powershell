...
namespace Microsoft.Azure.Commands.Compute.Automation
{
    ...
    public partial class UpdateAzureRmVmss : ComputeAutomationBaseCmdlet
    {
        ...
        [Parameter(
            Mandatory = false,
            HelpMessage = "Whether Auto AZ Balance will be applied for this VMSS.")]
        public bool EnableAutomaticZoneRebalancingPolicy { get; set; }

        [Parameter(
            Mandatory = false,
            HelpMessage = "Specifies the strategy/actions taken to balance the scale set. 'Recreate' replaces VMs by creating new ones with the same SKU without preserving disk, IPs or VM configuration. 'TargetScaleOut' helps grow the scale set in a zonally balanced manner to achieve a target instance count.")]
        [ValidateSet("Recreate", "TargetScaleOut")]
        ...
        [ValidateSet("CreateBeforeDelete")]
 ...
 private void BuildPatchObject()
        {
            ...
            if (this.IsParameterBound(c => c.EnableAutomaticZoneRebalancingPolicy))
            {
                ...
                if (this.VirtualMachineScaleSetUpdate.ZoneRebalancePolicy == null)
                {
                    this.VirtualMachineScaleSetUpdate.ZoneRebalancePolicy = new ZoneRebalancePolicy();
                }
                this.VirtualMachineScaleSetUpdate.ZoneRebalancePolicy.EnableAutomaticZoneRebalancing = this.EnableAutomaticZoneRebalancingPolicy;
            }
            ...
            if (this.IsParameterBound(c => c.AutomaticZoneRebalanceStrategy))
            {
                ...
                this.VirtualMachineScaleSetUpdate.ZoneRebalancePolicy.RebalanceStrategy = this.AutomaticZoneRebalanceStrategy;
            }
            ...
            if (this.IsParameterBound(c => c.AutomaticZoneRebalanceBehavior))
            {
                ...
                this.VirtualMachineScaleSetUpdate.ZoneRebalancePolicy.RebalanceBehavior = this.AutomaticZoneRebalanceBehavior;
            }
            ...
            if (this.IsParameterBound(c => c.AutomaticZoneRebalanceTargetInstanceCount))
            {
                ...
                this.VirtualMachineScaleSetUpdate.ZoneRebalancePolicy.TargetInstanceCount = this.AutomaticZoneRebalanceTargetInstanceCount;
            }
        }
 private void BuildPutObject()
        {
            ...
            if (this.IsParameterBound(c => c.EnableAutomaticZoneRebalancingPolicy))
            {
                if (this.VirtualMachineScaleSet.ZoneBalancePolicy == null)
                {
                    this.VirtualMachineScaleSet.ZoneBalancePolicy = new ZoneBalancePolicy();
                }
                this.VirtualMachineScaleSet.ZoneBalancePolicy.EnableAutomaticZoneRebalancingPolicy = this.EnableAutomaticZoneRebalancingPolicy;
            }
            ...
            if (this.IsParameterBound(c => c.AutomaticZoneRebalanceStrategy))
            {
                ...
                this.VirtualMachineScaleSet.ZoneBalancePolicy.AutomaticZoneRebalanceStrategy = this.AutomaticZoneRebalanceStrategy;
            }
            ...
            if (this.IsParameterBound(c => c.AutomaticZoneRebalanceBehavior))
            {
                ...
                this.VirtualMachineScaleSet.ZoneBalancePolicy.AutomaticZoneRebalanceBehavior = this.AutomaticZoneRebalanceBehavior;
            }
            ...
            if (this.IsParameterBound(c => c.AutomaticZoneRebalanceTargetInstanceCount))
            {
                ...
                this.VirtualMachineScaleSet.ZoneBalancePolicy.AutomaticZoneRebalanceTargetInstanceCount = this.AutomaticZoneRebalanceTargetInstanceCount;
            }
