...
namespace Microsoft.Azure.Commands.Compute
{
    ...
    public class UpdateAzureAvailabilitySetCommand : AvailabilitySetBaseCmdlet
    {
        ...
        [Parameter(
            Mandatory = false,
            HelpMessage = "Enable additional endpoints for scheduled events.")]
        public bool ScheduledEventsAdditionalEndpoints { get; set; }

        [Parameter(
            Mandatory = false,
            HelpMessage = "Enable user reboot scheduled events.")]
            ...
            if (this.ShouldProcess(AvailabilitySet.Name, VerbsData.Update))
            {
                ...
                ExecuteClientAction(() =>
                {
                    var avSetParams = new AvailabilitySet
                    {
                        ...
                        {
                            UltraSSDEnabled = this.ScheduledEventsAdditionalEndpoints
                        }
                    };
